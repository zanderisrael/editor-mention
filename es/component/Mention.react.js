...
var addMentionsToContentBlock = function addMentionsToContentBlock(contentState, block, trigger, suggestions) {
  ...
  var regex = getRegExp(trigger, suggestions, true, true);
...
var Mention = function (_React$Component) {
  ...
  Mention.prototype.render = function render() {
    ...
    var defaultValueState = defaultValue && EditorState.createWithContent(addMentionsToContentState(typeof defaultValue === 'string' ? ContentState.createFromText(defaultValue) : defaultValue, this.props.prefix, suggestions), this._decorator);
