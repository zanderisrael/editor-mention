...
function createMention() {
  ...
  var suggestionRegex = (0, _getRegExp2['default'])(config.prefix, config.suggestions, true);
  ...
  var decorators = [{
    ...
    component: function component(props) {
      return _react2['default'].createElement(_SuggestionPortal2['default'], (0, _extends3['default'])({}, props, componentProps, {
        ...
        suggestionRegex: (0, _getRegExp2['default'])(config.prefix, config.suggestions, false)
      }));
    }
  }];
